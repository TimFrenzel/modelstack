...
**Summary:** I use this kind of sheet when a small strip center looks fine on the flyer, but the lease rollover feels shaky once you slow down and look at it. It tracks six suites, pushes each one through downtime, TI spend, and leasing commissions, then rolls the result into a five-year hold and exit view. Good fit for a local buyer, broker, or owner who wants to see how one vacancy or one rough renewal can change the deal.
